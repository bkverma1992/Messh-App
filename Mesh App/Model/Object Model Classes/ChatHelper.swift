...
//  Mesh App
//
//  Created by Yugasalabs-28 on 17/11/2018.
...
final internal class ChatHelper {
    
    static let shared = ChatHelper()
    
    private init() {}
    
    enum MessageTypes: UInt32 {
        case Text = 0
